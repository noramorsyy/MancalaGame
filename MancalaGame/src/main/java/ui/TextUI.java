...
public class TextUI {
                ...
                if (winner == null) {
                    ...
                    if (winner.getName().equals(players.get(0).getName())) {
                        if (game.getBoard() instanceof KalahRules) {
                            players.get(0).getProfile().countKalah(true);
                            players.get(1).getProfile().countKalah(false);
                        } else {
                            players.get(0).getProfile().countAyo(true);
                            players.get(1).getProfile().countAyo(false);
                        }
                    } else {
                        if (game.getBoard() instanceof KalahRules) {
                            players.get(1).getProfile().countKalah(true);
                            players.get(0).getProfile().countKalah(false);
                        } else {
                            players.get(1).getProfile().countAyo(true);
                            players.get(0).getProfile().countAyo(false);
                        }
                    }
                }
    ...
    public static void main(String[] args) throws InvalidMoveException, GameNotOverException {
        ...
        if (choice.equals("y") || choice.equals("Y")) {
            ...
            System.out.println("Would you like to load a previous user profile for player one? y/N: ");
            ...
            System.out.println("Would you like to load a previous user profile for player two? y/N: ");
